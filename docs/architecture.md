...
Order is a runtime contract. Guard then Edit Approval form the safety prefix: Guard owns Bash, filesystem/protected decisions, and semantic confirmation; Edit Approval retains the independent edit/write workflow. Subagents precedes Implement because Implement consumes its managed runtime.
