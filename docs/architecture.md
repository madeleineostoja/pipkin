...
Order is a runtime contract. Guard, Readonly, and Shell Guard stay first so tool-call handlers apply in that safety order. Subagents precedes Implement because Implement consumes its managed runtime.
