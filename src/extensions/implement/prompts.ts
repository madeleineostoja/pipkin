...
export function buildAnchoredWorkstreamReviewPrompt(
  ...
  const assessmentFindings =
    ...
    "None.\n\nReturn `assessments: []`. Do not assess historical or residual findings.";
...
Return only a concise semantic summary, at least one verification statement, and uncertainty when applicable. Do not report commit IDs, branch names, trees, paths, or Git operation output: the orchestrator observes those directly.`;
}
