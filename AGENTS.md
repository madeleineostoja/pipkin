...
- Root registration order is a runtime contract. Sandbox and Readonly lead the bundle; Processes follows LSP and precedes Subagents, which precedes Implement; MCP follows Browser and precedes Papercuts.
