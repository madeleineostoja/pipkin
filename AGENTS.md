...
- Feature descriptions and schemas remain with their owners. Every model-supplied property, including nested fields and private managed completions, explains its meaning and material constraints. Update Guidance's static catalogue and structural bundle coverage when adding or removing a public tool.
